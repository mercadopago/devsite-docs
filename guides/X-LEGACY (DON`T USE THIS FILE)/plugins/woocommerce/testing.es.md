...
6. Selecciona el pago con tarjeta de crédito y usa la información de tarjeta disponible en nuestra página [Tarjetas locales de prueba](/developers/es/docs/woocomerce/additional-content/test-cards).
