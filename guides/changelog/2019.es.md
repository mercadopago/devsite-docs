...
- En caso de no informarse una “callback_url”, se muestra nuestra pantalla de success, sin disparar la redirección.

----[mlc]----

**Mejoras para Pagos Rechazados en Shopify**

- Se solucionó el problema cuando un cliente de Shopify selecciona Debito como medio de pago vía Webpay, y navega hacia atras en el browser, ya no se muestra la pantalla de congrats, sino que se rechaza el pago.
