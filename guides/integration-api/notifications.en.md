...
To integrate Webhook notifications, follow the instructions shown in [this documentation](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/en/guides/notifications/webhooks/webhooks).
