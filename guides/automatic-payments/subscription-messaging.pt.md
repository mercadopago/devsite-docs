...
> Importante
>
> No caso de operações com pagamentos recorrentes das bandeiras, será necessário enviar o identificador de transação da bandeira (TID) às transações de mensageria. Para mais informações sobe como enviar o TID, acesse a documentação [Network Transaction ID - TID](/developers/pt/docs/automatic-payments/recurring-charges/network-transaction-id).
