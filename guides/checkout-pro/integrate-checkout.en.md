...
2. Then, initialize the integration by setting your [public key](/developers/en/docs/checkout-pro/additional-content/credentials) using the following JavaScript code.
