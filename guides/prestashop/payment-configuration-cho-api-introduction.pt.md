...
----[mlb]----
* [Ticket checkout](/developers/pt/docs/prestashop/payment-configuration/checkout-api/ticket-checkout): pagamentos em dinheiro (saldo no Mercado Pago ou boleto bancário).
