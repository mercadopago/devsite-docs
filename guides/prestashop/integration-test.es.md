...
![Crear cuenta](prestashop/test-create-account-es.gif)
...
![Inicio de sesión](prestashop/test-login-esp.gif)
...
![Credenciales de producción](prestashop/test-prod-credentials-es.png)
...
![Credenciales de prueba](prestashop/test-test-credentials-es.png)
...
![Panel](prestashop/test-prestashop-es.png)

11. Recuerda activar el modo de producción en el campo "Producción".

![Panel](prestashop/test-prestashop-modeprod-es.png)
...
![Credenciales de producción](prestashop/test-prod-credentials-api-es.png)
...
![Credenciales de prueba](prestashop/test-test-credentials-api-es.png)

6. También ingresa las credenciales de prueba `access_token` y `public_key` en el campo **Credenciales de prueba**.

![Painel](prestashop/test-prestashop-es.png)
...
![Modo](prestashop/test-prestashop-testmode-es.png)
