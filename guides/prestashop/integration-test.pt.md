...
![Criar conta](prestashop/test-create-account.gif)
...
![Login](prestashop/test-login.gif)
...
![Credenciais de produção](prestashop/test-prod-credentials.png)
...
![Credenciais de teste](prestashop/test-test-credentials.png)
...
![Painel](prestashop/test-prestashop-pt.png)

11. Lembre-se de ativar o modo produção no campo "Production".

![Panel](prestashop/test-prestashop-modeprod-pt.png)
...
![Credenciais de produção](prestashop/test-prod-credentials-api.png)
...
![Credenciais de teste](prestashop/test-test-credentials-api.png)
...
![Modo](prestashop/test-prestashop-testmode-pt.png)
