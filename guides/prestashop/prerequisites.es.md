...
| Módulo Mercado Pago | En el **Panel Administrativo** de tu tienda PrestaShop, accede al **Catálogo de Módulos** y busca por Mercado Pago. Luego, instala el módulo y búscalo en la sección **Administrador de módulos**. Finalmente, haz clic en **Activar** para poder integrarlo en tu tienda. | Si tienes problemas para instalarlo y necesitas ponerte en contacto con nuestro soporte, es posible que se te pida que realices la [instalación manual](/developers/es/docs/prestashop/how-tos/install-module-manually). Mantén siempre el módulo actualizado con la última versión para garantizar la seguridad de los datos y el funcionamiento de la integración. |
| PrestaShop | Plataforma de comercio electrónico con software de código abierto, que permite a cualquier usuario crear y desarrollar un sitio web comercial. Accede al [sitio](https://prestashop.es/) para obtener más información. | Requerido 1.7.xo superior. |
