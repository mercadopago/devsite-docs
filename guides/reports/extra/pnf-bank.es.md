...
En la columna de DESCRIPTION puedes identificar a la cuota con el valor *INSTALLMENT* y en la columna de INSTALLMENTS puedes ver a qué número de cuota refiere.
...
En la columna de DESCRIPTION puedes identificar cada cuota con el valor *INSTALLMENT* y a la devolución total como *REFUND*. 
