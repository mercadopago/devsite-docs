...
| `detailed` | <br/>Inclui colunas com informações mais detalhadas sobre suas operações:<br/> - Comissão do  Mercado Livre (`mkp_fee_amount`)<br/> - Comissão por oferecer parcelas sem juros (`financing_fee_amount`)<br/> - Custos de envio (`shipping_fee_amount`)<br/> ----[mla]---- - Impostos cobrados por retenções de IIBB (`taxes_amount`) ------------ ----[mlm]---- - Impostos recebidos (`taxes_amount`) ------------ ----[mlu]---- - Impostos recebidos (`taxes_amount`) ------------ ----[mlc]---- - Impostos recebidos (`taxes_amount`) ------------ ----[mco]---- - Impostos recebidos (`taxes_amount`) ------------ ----[mpe]---- - Impostos recebidos (`taxes_amount`) ------------ ----[mlb]---- - Impostos recebidos (`taxes_amount`) ------------ <br/> - Parcelas (`installments`)<br/> <br/><br/>|
