...
| `detailed` | <br/>Incluye columnas con información más detallada sobre tus operaciones:<br/> - Comisión de Mercado Libre (`mkp_fee_amount`)<br/> - Impuesto financiero (`financing_fee_amount`)<br/> - Impuesto de envío (`shipping_fee_amount`)<br/> ----[mla]---- - Impuestos  cobrados por retenciones de IIBB (`taxes_amount`) ------------ ----[mlm]---- - Impuestos cobrados (`taxes_amount`) ------------ ----[mlu]---- - Impuestos cobrados (`taxes_amount`) ------------ ----[mlc]---- - Impuestos cobrados (`taxes_amount`) ------------ ----[mco]---- - Impuestos cobrados (`taxes_amount`) ------------ ----[mpe]---- - Impuestos cobrados (`taxes_amount`) ------------ ----[mlb]---- - Impuestos cobrados (`taxes_amount`) ------------ <br/> - Cuotas (`installments`)<br/> <br/><br/>|
