...
> Important
>
> To set up notifications for Ecosistema Presencial, you must use the **Integraciones Presenciales** event, which will contain the `type` field with the value `topic_instore_integration_wh`. Through this event, you will receive notifications of the final states of intents, whether processed by Point or QR in integrated mode.
