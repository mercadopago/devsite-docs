...
| 4            | DNI/CUIL/CUIT             | N(011)   | DNI, CUIL ou CUIT do cliente.                                                                                                                     | C*                                    |
| 2            | Código do cliente         | AN(020)  | Identificador utilizado pela empresa para identificar seus clientes. Lembre-se de que você deve respeitar o formato indicado durante o processo de incorporação. | C                                     |
| 7            | Data do primeiro vencimento  | N(008)   | Data do primeiro vencimento no formato AAAAMMDD.                                                                                                  | M                                     |
| 8            | Valor do primeiro vencimento | N(,2)    | Valor do primeiro vencimento. É um número inteiro onde os dois últimos dígitos representam os decimais.                                           | M                                     |
| 9            | Data do segundo vencimento   | N(008)   | Data do segundo vencimento, no formato AAAAMMDD.                                                                                                  | O                                     |
| 10           | Valor do segundo vencimento  | N(,2)    | Valor do segundo vencimento. Trata-se de um número inteiro no qual os dois últimos dígitos representam os decimais.                               | O                                     |
| 11           | Data do terceiro vencimento  | N(008)   | Data do terceiro vencimento, no formato AAAAMMDD.                                                                                                 | O                                     |
| 12           | Valor do terceiro vencimento | N(,2)    | Valor do terceiro vencimento. É um número inteiro onde os dois últimos dígitos são decimais.                                                      | O                                     |
| 3            | Nome completo             | AS(100)  | Nome completo do cliente sem caracteres especiais.                                                                                                | O - Links Massivos <br>M - Carga na Wallet |
| 5            | Telefone do cliente          | ANS(20)  | Telefone do cliente.                                                                                                                              | O                                     |
| 6            | Endereço de e-mail        | ANS(64)  | E-mail do cliente onde ele receberá as notificações sobre a existência de uma nova dívida para a empresa.                                         | O                                     |
