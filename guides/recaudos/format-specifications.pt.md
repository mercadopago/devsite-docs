...
| 2                | Se criar Links de pagamento: Opcional / Se criar Dívidas: Obrigatório condicional para empresas na Argentina que identificam seus clientes por meio de DNI/CUIL/CULT | DNI/CUIL/CUIT       | DNI, CUIL ou CUIT do cliente. Aplicável para empresas na Argentina que identificam seus clientes por DNI/CUIL/CUIT. Links de Pagamento / Dívidas | Campo numérico inteiro de até 11 caracteres | 01234567895 |
| 3                | Se criar Link de pagamento: Opcional / Se criar Dívidas: Obrigatório condicional para empresas na Argentina que identificam seus clientes por meio de Código do cliente | Código do cliente  | Identificador usado pela empresa para identificar seus clientes. Aplicável para empresas que identificam seus clientes por Código do cliente. Links de Pagamento / Dívidas | Campo alfanumérico de 1 a 20 caracteres | COD1234      |
...
| 15               | Opcional (somente para casos na Colômbia) | Imposto            | Imposto.                                                                                                                                              | Campo numérico inteiro. Pode ser 0, 5 ou 19. Se não for inserido um valor, será utilizado 19 por padrão | 5            |
