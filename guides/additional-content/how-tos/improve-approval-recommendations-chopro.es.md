...
Si, en cambio, quieres garantizar una interfaz optimizada, puedes utilizar los **componentes visuales** de [Checkout Bricks](/developers/es/docs/checkout-bricks/landing), así como aprovechar el componente visual ya listo con los mejores mensajes del s[Status Screen Brick](/developers/es/docs/checkout-bricks/status-screen-brick/introduction).
