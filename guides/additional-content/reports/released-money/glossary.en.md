...
| EXTERNAL_REFERENCE | <br/> This information allows you to identify a transaction according to its origin. The code could be: <br/> - Order ID through the order or shipment (if it refers to a cart purchase). <br/> - Its own ID provided by the seller in case it is an external integration. <br/><br/>This field may be empty for some cases, such as invoice payments, money transfers, among others. <br/><br/>|
