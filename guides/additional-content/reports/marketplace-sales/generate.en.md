...
| `columns` (required)       | Field with details of the columns to be included in your report. Find all possible values in the [Glossary](/developers/en/guides/additional-content/reports/marketplace-sales/glossary) section. |
