...
| `columns` (obligatorio)       | Campo con el detalle de columnas a incluir en tu reporte. Encuentra todos los posibles valores en la sección [Glosario](/developers/es/guides/additional-content/reports/marketplace-sales/glossary).|
