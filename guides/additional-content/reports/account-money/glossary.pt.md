...
| ID da transação no Mercado Pago (`SOURCE_ID`) | ID da transação no Mercado Pago (por exemplo, o pagamento de uma venda).  ----[mla, mlb]---- Este campo pode conter valores alfanuméricos ------------ |
