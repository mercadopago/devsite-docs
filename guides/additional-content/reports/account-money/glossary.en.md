...
| METADATA | ----[mlu, mla, mlm, mco, mlc, mlb]---- Extra data such as the ID of partial returns or data provided by the seller in case of having an external integration. ------------ ----[mpe]---- Extra data such as data provided by the seller in case of having an external integration. ------------ ----[mlb]---- "Rebate" is shown, it is understood as the promotional discount assumed by Mercado Libre in co-financed promotions. ------------ |
