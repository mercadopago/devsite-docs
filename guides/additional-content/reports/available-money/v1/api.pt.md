...
| `detailed` | <br/>Inclui colunas com informações mais detalhadas sobre suas operações:<br/> - Comissão do Mercado Pago (`mp_fee_amount`)<br/> - Comissão por oferecer parcelas sem acréscimos (`financing_fee_amount`)<br/> - Valor bruto da transação (`gross_amount`)<br/> - Meios de pagamento (`payment_method`)<br/> - Parcelas (`installments`)<br/> - Cupom de desconto (`coupon_amount`) <br/> - Custos de envio (`shipping_fee_amount`) <br/> - Impostos cobrados por retenções de IIBB (`taxes_amount`) <br/> - Valor recebido por compras com split (`seller_amount`)<br/><br/>|
