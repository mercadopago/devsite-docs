...
## Usando o campo `state`

Para aumentar a segurança da integração, recomendamos incluir o parâmetro `state` para garantir que a resposta pertença a uma solicitação iniciada pelo mesmo aplicativo.
