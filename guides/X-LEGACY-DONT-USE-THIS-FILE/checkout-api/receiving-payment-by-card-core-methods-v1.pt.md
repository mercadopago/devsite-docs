...
[Configure notificações webhooks](/developers/pt/guides/notifications/webhooks/webhooks) ou [notificações IPN](/developers/pt/guides/checkout-api/additional-content/your-integrations/notifications/ipn).
