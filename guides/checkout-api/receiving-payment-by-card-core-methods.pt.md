...
> Caso deseje realizar um fluxo de pagamento automatizado, recomendamos você [utilizar a funcionalidade CardForm do MercadoPago.js](/docs/checkout-api/payment-methods/receiving-payment-by-card).
