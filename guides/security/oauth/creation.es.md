...
| --- | --- | --- |
| Cuentas de vendedor de Mercado Pago | Se requerirán cuentas de vendedor de Mercado Pago. Una para ti y otra para el vendedor. | Cuenta de vendedor en Mercado Pago. Si no la tienes, haz [clic aquí](https://www.mercadopago[FAKER][URL[DOMAIN]/hub/registration/landing) para crear. |
...
2. Envía la URL de autenticación al vendedor cuya cuenta quieres vincular a la tuya con los siguientes campos:
