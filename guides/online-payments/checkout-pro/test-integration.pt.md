...
| Comprador | É a conta que você usa para **testar o processo de compra.**<br/>Existem duas formas de fazer o pagamento: como **usuário convidado**, preenchendo apenas o seu endereço de e-mail, e como **usuário cadastrado**, acessando a conta do Mercado Pago com usuário e senha. Nesse último cenário, cartões previamente salvos e saldo disponível na conta estarão habilitados como meios de pagamento. |
