...
> Buenas prácticas
>
> Utilice nuestro [video tutorial](#bookmark_video_tutorial) y el [ejemplo de implementación básica](#bookmark_ejemplos_descargables) para comprender más sobre la integración completa con Checkout Pro.
...
> Ten en cuenta que es necesario configurar las `back_urls` si deseas volver a tu sitio al finalizar el pago. Para más información, viste la sección [Integración avanzada](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/es/guides/online-payments/checkout-pro/advanced-integration#bookmark_url_de_retorno).
...
Consulte el [ejemplo de integración completa](http://github.com/mercadopago/checkout-payment-sample) en GitHub para PHP o NodeJS para descargar un proyecto básico de implementación rápida de Checkout Pro en su sitio.
