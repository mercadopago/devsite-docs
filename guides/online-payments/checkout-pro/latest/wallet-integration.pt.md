...
1. Integre o [Checkout Pro](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/online-payments/checkout-pro/integration) para criar suas preferências de pagamento e para adicionar o botão ao seu site.
2. Quando criar a preferência, basta adicionar o atributo que permite [receber pagamentos apenas de usuários cadastrados](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/online-payments/checkout-pro/configurations/#bookmark_aceitar_pagamentos_somente_de_usuários_cadastrados).
