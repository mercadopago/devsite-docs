...
_Aplicação (application)_ | As aplicações são usadas para processar os pagamentos do vendedor. **Cada aplicação identifica uma integração específica**, pois cada uma possui suas próprias<a href="[FAKER][CREDENTIALS][URL]" target="_blank"> credenciais </a>. Uma conta do Mercado Pago pode ter diversas aplicações.<br/><br/>Você pode encontrar as informações de cada uma em credenciais. Ao entrar, um será criado automaticamente ou você poderá <a href="https://www.mercadopago.com/developers/panel/applications" target="_blank"> criar uma aplicação</a> sempre que precisar.
...
>
> [Integre o Checkout Pro](http://www.mercadopago.com.br/developers/pt/guides/online-payments/checkout-pro/integration/)
