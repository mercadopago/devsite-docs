...
Use a [chave pública de produção](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/panel/credentials) do seu usuário vendedor de teste na hora de criar a assinatura que quiser testar.<br>
