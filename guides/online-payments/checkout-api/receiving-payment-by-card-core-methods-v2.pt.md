...
1. [Inclua a biblioteca MercadoPago.js](#1-inclua-a-biblioteca-mercadopagojs)
2. [Adicione o formulário de pagamento](#2-adicione-o-formulário-de-pagamento)
3. [Configure sua chave pública](#3-configure-sua-chave-pública)
4. [Crie os campos PCI](#4-crie-os-campos-pci)
5. [Obtenha os dados para seu formulário](#5-obtenha-os-dados-para-seu-formulário)
6. [Crie o token do cartão](#6-crie-o-token-do-cartão)
...
O segundo parâmetro são opções, e pode receber valor para **placeholder** e **style**. O valor para **placeholder** e **style** deve ser uma *string*, sendo ignorado quando inválido, com a exibição de um warning no console. Já style, é um *objeto* com as chaves sendo o nome da propriedade CSS e os valores uma *string*.
...
Se você quiser saber mais sobre outros eventos customizados, acesse nossa documentação do [GitHub](https://github.com/mercadopago/sdk-js).
