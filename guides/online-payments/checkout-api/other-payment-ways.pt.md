...
Por padrão, a data de vencimento para pagamentos em dinheiro pode variar entre 7 e 30 dias, dependendo do meio de pagamento que você está usando. Opcionalmente é possível alterar essa data enviando o campo `date_of_expiration` na requisição de criação do pagamento. A data configurada deve estar entre 1 e 30 dias a partir da data de emissão.
