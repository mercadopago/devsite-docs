...
2. Escolha o tipo de checkout que deseja [Checkout Pro](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/online-payments/checkout-pro/introduction) ou [[----[mla, mlu, mpe, mco, mlc, mlm]----Checkout API------------ ----[mlb]----Checkout Transparente------------]](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/online-payments/checkout-api/introduction) e siga todo o fluxo de integração.
