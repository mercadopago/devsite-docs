...
Si ya cuentas con una afiliación de gateway MercadoPagoV1, deberás crear ahora una **nueva afiliación MercadoPagoV2**. Es sencillo y similar al paso a paso que has hecho al configurar el conector anterior, por lo que deberás prestar particular atención al proceso y la descripción de los campos a continuación.
