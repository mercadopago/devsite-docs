...
> Important
>
>The DNI associated with the card must be the same as the test user making the purchase. To confirm this information, in your Mercado Pago user account, access **Your Profile > Your information** and review the **Document field**, ensuring that it will be the same to be associated with the card.
