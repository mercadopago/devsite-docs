...
> Prerequisites
>
> * Implement the [payment processing via API](https://www.mercadopago.com.ar/developers/en/guides/online-payments/checkout-api/receiving-payment-by-card#recibir-un-pago-con-tarjeta).
...
Once you got the card_token, you can [create the payment](https://www.mercadopago.com.ar/developers/en/guides/online-payments/checkout-api/receiving-payment-by-card#recibir-un-pago-con-tarjeta).
