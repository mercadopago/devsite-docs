...
* [Configurá tus números de comercio y medios de pago](https://www.mercadopago.com.ar/developers/es/guides/gateway/configuration.es.md) en el backoffice de Mercado Pago
