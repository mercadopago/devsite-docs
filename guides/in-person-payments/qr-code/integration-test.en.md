...
Test users allow you to test the integration of your system with Mercado Pago without using real money.
...
Lastly, make sure you’ve received a status notification in your system. And you’re done!
...
| **Second payment attempt**. User first performs a rejected payment and then executes an approved payment. | Point of sale system receives information about the rejected payment and an approved payment later.| Don’t remove the order after a rejected payment.|
