...
> En caso de no haber configurado todavía Checkout Pro, accede a la sección [Configuración de pago > Checkout Pro](/developers/es/docs/nuvemshop/payments-configuration/checkout-pro).
