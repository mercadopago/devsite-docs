...
----[mlb]----
* [Medios de pago offline - Boleto bancário](/developers/es/docs/woocommerce/payments-configuration/checkout-api/offline-payments): pagos en efectivo (Dinero en cuenta de Mercado Pago o boleto bancário) y pago de lotería sin boleto (con CPF).
