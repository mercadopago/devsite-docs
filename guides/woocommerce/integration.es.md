...
3. Ingresa tus credenciales de **test** y **producción** en los campos obligatorios. Si aún no tienes esta información, accede a nuestra documentación [Credenciales](https://www.mercadopago.[FAKER][URL][DOMAIN]/developers/es/guides/credentials/credentials) y sigue el paso a paso para obtenerlas. 
...
>
> [Prueba de compras](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/es/guides/woocommerce/testing)