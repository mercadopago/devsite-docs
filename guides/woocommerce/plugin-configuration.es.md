...
> Si tiene preguntas sobre la instalación del plugin, consulte más información en la sección [Requisitos previos.](/developers/es/docs/woocommerce/previous-requirements)
