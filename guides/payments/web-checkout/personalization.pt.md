...
Para saber mais sobre os atributos da preferência, consulte as [Referências da API](https://www.mercadopago.com.br/developers/pt/reference/preferences/_checkout_preferences/post/)
