...
> Prerequisites
>
> * Have the tool to [collect card information](https://www.mercadopago.com.ar/developers/en/guides/payments/api/receiving-payment-by-card.es.md#Collect-card-information) implemented.
...
The `token` is captured during the [collection of card information](https://www.mercadopago.com.ar/developers/en/guides/payments/api/receiving-payment-by-card.es.md#Collect-card-information).
...
The process is similar to the [collection of card information](https://www.mercadopago.com.ar/developers/en/guides/payments/api/receiving-payment-by-card.es.md#captura-los-datos-de-tarjeta). You must create a `card token` by sending the `$form` with the `cardId` and the `securityCode`:
