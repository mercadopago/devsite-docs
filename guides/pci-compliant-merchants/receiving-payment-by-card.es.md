...
> Pre-requisitos
>
> * Implementar el [procesamiento de pagos por Checkout API](https://www.mercadopago.com.ar/developers/es/guides/payments/api/receiving-payment-by-card#recibir-un-pago-con-tarjeta).
