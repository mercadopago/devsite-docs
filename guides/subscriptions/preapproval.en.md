...
> <br><br>
> In the case of Master and Amex credit cards, the credit card will appear as: `MERPAG*&gtbrand_name&gt`. So for these means that for this payments methods you can communicate: "In your summary you will see the charge as `MERPAG*&gtbrand_name&gt`" where `*&gtbrand_name&gt` is configured from the Market account Seller payment: **Menu -> Settings> Name of my business**.
> <br><br>
