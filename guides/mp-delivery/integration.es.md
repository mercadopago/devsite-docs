...
4. Utiliza las API disponibles para consultar y gestionar información de tus sucursales. Ver [Administración de tiendas](/developers/es/docs/mp-delivery/store-management).
