...
1. [Instalar Checkout Pro](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/es/guides/shopify/checkout-pro)
2. [Instalar Checkout API](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/es/guides/shopify/checkout-api)
