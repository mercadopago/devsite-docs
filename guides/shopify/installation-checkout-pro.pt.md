...
1. Digite as suas **credenciais de produção** Client_id e Client_secret nos campos que as solicitam. Lembre-se de ter suas [credenciais](/docs/shopify/additional-content/credentials) à mão. 
