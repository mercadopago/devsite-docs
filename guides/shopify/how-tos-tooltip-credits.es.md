...
Para integrar el Mercado Pago Banners, instala la aplicación a través del [panel de Shopify](/developers/es/docs/shopify/integration-configuration/checkout-cards#instalarvapaneldeshopify) o a través del [Marketplace](/developers/es/docs/shopify/integration-configuration/checkout-cards#instalarvamarketplace). 

## Instalar vía panel de Shopify

Para instalar Mercado Pago Banners a través del panel administrativo de Shopify, sigue los pasos a continuación:
...
Para instalar Mercado Pago Banner a través del Marketplace, sigue los pasos a continuación:
