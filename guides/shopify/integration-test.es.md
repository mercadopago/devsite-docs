...
5. En la pantalla de pago, elije **pagar con una nueva tarjeta de crédito** y usa las [tarjetas de prueba](/developers/es/docs/shopify/test-cards) para realizar el pago. **No inicies sesión en tu cuenta de Mercado Pago o intentes realizar el pago con tarjetas de uso personal.**
