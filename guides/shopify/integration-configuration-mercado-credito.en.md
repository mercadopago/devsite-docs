...
> If you haven't set up Checkout Pro yet, you must access the [Integration configuration > Checkout Pro](/developers/en/docs/shopify/integration-configuration/checkout-pro) section to configure it.
