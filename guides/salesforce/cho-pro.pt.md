...
2. Para ativar a forma de pagamento com cartões de crédito ou débito, posicione-se na opção **Mercado Pago**. Em seguida, na coluna "Ativado" e selecione a opção **Sim** para habilitá-lo.