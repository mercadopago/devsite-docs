...
| PAYMENT_METHOD_TYPE | <table style="border:none;background:none;font-size:16px;" ><tr style="border:none;background:none;"><td style="border:none;background:none;"> Tipo de medio de pago. <br/> Puede ser:<br/><ul><li> MLA: Argentina</li><li>MLM: México</li><li>MLU: Uruguay</li><li>MLC: Chile</li><li>MCO: Colombia</li><li>MPE: Perú</li><li>MLB: Brasil</li></ul></td></tr><tr style="border:none;"></table> |
