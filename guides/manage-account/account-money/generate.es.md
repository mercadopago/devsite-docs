...
| Elemento o acción | Características |
| ------------ |	--------    |
| Formato del filename | <br/>Cuando el reporte es programado o manual:<br/> "prefijo-configurable-<span style='color:#999999;'>fecha-de-creación-hh-mm-ss.csv</span>" <br/> Ejemplo:  mitienda-28-05-2019104010.csv<br/> |
