...
Você pode gerar um relatório de ----[mla]---- Liquidações ------------ ----[mlm, mlb, mlc, mco, mec, mlu, mpe]---- Liberações ------------ pela sua conta Mercado Pago:
...
>
> Saiba o que é o relatório de ----[mla]---- Liquidações ------------ ----[mlm, mlb, mlc, mco, mec, mlu, mpe]---- Liberações ------------ e para que serve. 
>
