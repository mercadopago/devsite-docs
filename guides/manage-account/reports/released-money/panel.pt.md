...
Gere seus relatórios de ----[mla]---- Liquidações ------------ ----[mlm, mlb, mlc, mco, mec, mlu, mpe]---- Liberações ------------ a partir do seu painel do Mercado Pago.
...
1. Vá em [relatório de ----[mla]---- Liquidações ------------ ----[mlm, mlb, mlc, mco, mec, mlu, mpe]---- Liberações ------------](https://www.mercadopago.com.ar/balance/reports/release) e clique em *Gerar relatório*.
