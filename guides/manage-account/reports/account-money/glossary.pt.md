...
| PAYMENT_METHOD | Confira os [meios de pagamento disponíveis](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/resources/localization/payment-methods/#bookmark_argentina) de acordo com o país no qual você opera com o Mercado Pago. |
