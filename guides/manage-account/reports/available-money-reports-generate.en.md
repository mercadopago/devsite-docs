...
| `Filename Format` | <br/>When the report is scheduled or manual: <br/> "configurable-prefix-creation-date.csv" <br/> Example:  mystore-28-05-2019.csv <br/><br/> When the report is generated by a money withdrawal: <br/> "configurable-prefix-withdrawal-id-creation-date.csv"<br/> Example: mystore-ID23902138-28-05-2019.csv <br/> <br/> |
