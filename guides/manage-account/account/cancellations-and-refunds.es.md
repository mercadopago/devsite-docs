...
En esta documentación encontrarás la información necesaria para realizar una devolución total, parcial y cancelar una compra en tu tienda.
...
- **Status de pago**: Cancelaciones solo se pueden realizar si el estado de pago es Pending o In process. Estos status se muestran en la respuesta a la llamada de la API de cancelación en los campos de, *Status* y *Status detail* respectivamente.
