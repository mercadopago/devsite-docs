...
> Important
>
> The [credentials](https://www.mercadopago.com.ar/developers/en/guides/faqs/credentials/) are the keys that uniquely identify you within the platform. To operate in a **test environment** with which to simulate online payments, use the test credentials. Use **production** credentials to receive real payments.
