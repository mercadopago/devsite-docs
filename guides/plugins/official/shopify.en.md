...
> Important
>
> Soon, the Mercado Pago Transparent Checkout for Shopify will be deprecated for new users and replaced by a new model, more customizable and that allows it to offer Pix. [Click here](https://forms.gle/meBfN6KH6497rFSZ7) and register to receive the launch communication.
