...
------------
__Checkout redirect Mercado Pago__: configura el Checkout de Mercado Pago para que tus clientes finalicen su pago en nuestro sitio. Ya se encuentra pre-instalada en tu administrador de Shopify.
