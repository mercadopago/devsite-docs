...
1. Complete the fields Client ID and Client Secret with the [credentials of your Mercado Pago account]((https://www.mercadopago[FAKER][URL][DOMAIN]developers/en/guides/resources/faqs/credentials)).
1. Click on “Close” and then on “Save changes”.
<p>&nbsp;</p>
...
1. Complete the fields “Client ID, Client Secret and Public Key” with the [credentials of your Mercado Pago account]((https://www.mercadopago[FAKER][URL][DOMAIN]developers/en/guides/resources/faqs/credentials)).
1. Click on “Close” and then on “Save changes”.
<p>&nbsp;</p>
