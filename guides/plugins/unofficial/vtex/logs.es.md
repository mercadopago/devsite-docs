...
Para obtener más información, accede al enlace [Resultados de la creación de un cobro](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/es/guides/online-payments/checkout-api/handling-responses).
