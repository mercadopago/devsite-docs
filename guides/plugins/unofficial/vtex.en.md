...
6. Set a description (optional).
7. Select the affiliation.
8. Set status active to activate the payment method in checkout - could be set up and activated later.
9. Save.
