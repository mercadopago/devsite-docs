...
3. Em **E-mails**, habilite o envio a ser configurado selecionando a opção ˜ativar esse e-mail de notificação".
4. Personalize o template do e-mail com: os destinatários, o assunto do e-mail e o cabeçalho.
5. Insira o **conteúdo** a ser enviado e selecione o tipo do e-mail.
6. Indique também o nome e o endereço de e-mail do remetente, além do logo e das cores da sua loja.
7. Feitas as devidas configurações, instale e configure um **servidor de SMTP** de sua preferência para viabilizar o envio dos e-mails. 
8. Envie um **e-mail de teste** para garantir que a plataforma está enviando os e-mails corretamente.
