...
Para mais informações, acesse nossa documentação [Requisitos para entrar em produção](https://www.mercadopago.com.br/developers/pt/guides/online-payments/checkout-api/goto-production).
...
4. Em **Como você quer operar o checkout da sua loja**, selecione a opção **Ativar modo Produção para checkouts Mercado Pago**. 
