...
| --- | --- |
| Wallet Connect permission | To enable your application, consume the APIs mentioned in the documentation, and receive payments through Mercado Pago Wallet, contact your **sales executive**. |
