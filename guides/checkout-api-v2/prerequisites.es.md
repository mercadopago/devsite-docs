...
Para integrar ----[mlb]---- Checkout Transparente------------ ----[mla, mlm, mlu, mco, mlc, mpe]---- Checkout API ------------, es importante cumplir con los requisitos que se muestran a continuación.
...
Si se cumplen todos los requisitos previos, podrás realizar la integración de ----[mlb]---- Checkout Transparente------------ ----[mla, mlm, mlu, mco, mlc, mpe]---- Checkout API ------------.
