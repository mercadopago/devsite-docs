...
In addition, by using our SDKs, you can store your card data whenever a payment is successfully completed. This allows the correct data to be stored securely in our servers for future purchases, and streamlines the payment process for the buyer. For more information, check our [API Reference](/developers/en/reference/cards/_customers_customer_id_cards/post).
