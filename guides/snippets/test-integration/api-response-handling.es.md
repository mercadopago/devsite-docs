...
Te recomendamos usar los [mensajes de respuesta](/developers/es/guides/checkout-api/handling-responses) y utilizar la comunicación sugerida en cada uno de los casos.
