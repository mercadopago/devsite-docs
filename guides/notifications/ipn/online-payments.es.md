...
Vea a continuación cómo configurar notificaciones tipo IPN para pagos en línea.
...
1. Accede a la pantalla [Notificaciones IPN](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/panel/notifications/ipn/introduction).
