...
| `shipments` | `shipment_id`| 	Dados de envio do pedido |
| `shipments` | `ready_to_ship`| Pedido está passível de ser entregue|
| `shipments` | `shipment_id`| 	Devolve os dados de envio |
