...
![Configuration of the payment method screen](adobe-commerce/cho-api-config2-mlb-pt.png)
...
![Common payment method definitions screen](adobe-commerce/cho-api-credits-definitions-mlb-pt.png)
...
1. In the store **Control Panel**, go to **Stores > Configuration > Sales > Payment Methods**.
2. In **Other payment methods**, click on the Mercado Pago plugin, and then on **Configure**.
    ![Mercado Pago's plugin configuration screen](adobe-commerce/cho-api-credits-config-mla-es.png)
...
![Configuration of the payment method screen](adobe-commerce/cho-api-credits-config2-mla-es.png)
...
![Common payment method definitions screen](adobe-commerce/cho-api-credits-definitions-mla-es.png)
...
![Configuration of the payment method screen](adobe-commerce/cho-api-credits-config2-mlm-es.png)
