...
![Criar conta](adobe-commerce/test-create-account.gif)
...
![Login](adobe-commerce/test-login.gif)
...
![Credenciais de produção](adobe-commerce/test-prod-credentials.png)
...
![Painel](adobe-commerce/test-adobe-commerce.png)
...
![Credenciais de teste](adobe-commerce/test-test-credentials-api.png)
...
![Painel](adobe-commerce/test-adobe-commerce-all.png)
