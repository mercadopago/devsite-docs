...
bullet_section_with_media:
 ...
 - benefit_message: O pagamento é realizado na página do Mercado Pago (dentro ou fora da sua loja) com cartões de débito ou crédito, cartões salvos (Mercado Livre e Mercado Pago), pagamentos offline (boleto bancário, caixa eletrônico e lotéricas), saldo no Mercado Pago e Pix. 
 - benefit_title: Checkout Transparente
 - benefit_message: O pagamento é realizado sem sair da sua loja virtual com cartões (débito ou crédito), pagamentos offline (boleto bancário e caixa eletrônico), Pix e parcelamento via Pix em até 12x.
...
bullet_section_with_media:
 ...
 - message: Com o módulo do Mercado Pago você pode configurar o pagamento utilizando:
 - benefit_title: Checkout Pro
 - benefit_message: O pagamento é realizado na página do Mercado Pago (dentro ou fora da sua loja) com cartões de débito ou crédito, cartões salvos (Mercado Livre e Mercado Pago), dinheiro (efectivo) saldo no Mercado Pago e transferência bancária.
...
bullet_section_with_media: 
 - title: Vantagens
 - type: normal
 - benefit_title: Customização dos meios de pagamento em Checkout Pro
