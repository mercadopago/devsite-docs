...
To use the Mercado Pago integration with Adobe Commerce in your store, you must meet the requirements described in the table below.
...
| Adobe Commerce | 100% customizable e-commerce platform that integrates perfectly with the main technologies on the market and can be deployed in any environment. [Click here](https://business.adobe.com/br/products/magento/magento-commerce.html) for more information.| Required 2.3.x |
...
> This module is configured to support Adobe Commerce standards. We recommend that you do not use modules or plugins that change the characteristics and operation of the Adobe Commerce standard to avoid possible errors in the module or that it stops working.

If all the prerequisites are met, you can install the Mercado Pago módulo on the Adobe Commerce platform.