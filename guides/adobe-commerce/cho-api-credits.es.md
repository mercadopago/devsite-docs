...
3. Selecciona la opción **Financiación vía Pix en hasta 12 veces** y configura los campos de acuerdo a las indicaciones siguientes.
   ...
   4. Cuando el cliente no tenga una línea de crédito activa para utilizar Financiación vía Pix en hasta 12 veces, lo redireccionaremos a Mercado Pago. La opción **Medio de pago finalizado** te permite eliminar medios de pago de Mercado Pago , pero si el cliente desea utilizar alguno de ellos igualmente, deberá volver al checkout para completar el pago.

![Pantalla de configuración del medio de pago](adobe-commerce/cho-api-config2-mlb-pt.png)
...
![Pantalla de definiciones comunes de medios de pago](adobe-commerce/cho-api-credits-definitions-mlb-pt.png)
...
1. En el Panel de Control de la tienda, accede a **Stores> Configuration> Sales>Payments Methods**.
2. En **Other Payments Methods**, haz click en **Configure** dentro del plugin de Mercado Pago.
    ![Pantalla con las opciones dentro del plugin de Mercado Pago](adobe-commerce/cho-api-credits-config-mla-es.png)
...
![Pantalla de configuración del medio de pago](adobe-commerce/cho-api-credits-config2-mla-es.png)
...
![Pantalla de definiciones comunes de medios de pago](adobe-commerce/cho-api-credits-definitions-mla-es.png)
...
![Pantalla de configuración del medio de pago](adobe-commerce/cho-api-credits-config2-mlm-es.png)
