...
| **Expiração do pedido**. O usuário tenta pagar após a expiração do QR. | Verifique se você definiu o campo `expiration_date` no pedido e se ele é anterior ao momento em que o pedido é escaneado. |
