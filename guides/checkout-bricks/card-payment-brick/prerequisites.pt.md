...
Para realizar a integração do Card Payment Brick, é preciso atender aos requisitos listados abaixo.
...
Se todos os pré-requisitos foram atendidos, você poderá realizar a integração do Card Payment Brick.