...
Para realizar a integração do Wallet Brick, é preciso atender aos requisitos listados abaixo.
...
| Conta de vendedor Mercado Pago ou Mercado Livre | Para integrar o Wallet Brick é preciso uma conta de vendedor no Mercado Pago ou Mercado Livre. Caso não tenha, [clique aqui](https://www.mercadopago[FAKER][URL][DOMAIN]/hub/registration/landing) para criar. | 
...
Se todos os pré-requisitos foram atendidos, você poderá realizar a integração do Wallet Brick.