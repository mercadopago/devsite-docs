...
> <br/></br>
> And, to help, we've prepared a complete [code example](/developers/en/docs/checkout-bricks/wallet-brick/code-example-onsubmit) of the Wallet Brick configuration with Mercado Pago Wallet that you can use as a template.
