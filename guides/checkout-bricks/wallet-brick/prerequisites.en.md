...
To perform a Wallet Brick integration, you must meet the requirements listed below.
...
| Mercado Pago or Mercado Libre seller account | To integrate Wallet Brick you need a seller account on Mercado Pago or Mercado Libre. If not, [click here](https://www.mercadopago[FAKER][URL][DOMAIN]/hub/registration/landing) to create. |
...
If all the prerequisites are met, you can perform the Wallet Brick integration.