...
Para configurar pagos con **Efecty**, envía un POST con los siguientes parámetros al endpoint [/v1/payments](/developers/es/reference/payments/_payments/post) y ejecuta la solicitud o, si lo prefieres, utiliza uno de nuestros SDKs indicados a continuación.
...
![payment-submission-other-payment-methods-status-mco](checkout-bricks/payment-submission-other-payment-methods-status-mco-es.png)
