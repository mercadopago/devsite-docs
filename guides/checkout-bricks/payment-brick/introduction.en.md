...
| Boleto or PEC payment form  | Field for entering the house number <br><br> Propriedade: addressStreet | **Valor**: N/A <br> **Label**: Rua <br> **Placeholder**: Ex.: Av. Paulista <br> **Tipo**: string <br> **Formato**: N/A <br> **Máx. caracteres**: a depender do emissor, podendo variar entre 15 e 16.| Mandatory <br> Customizável (label, placeholder) |
