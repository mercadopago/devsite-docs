...
To offer **Rapipago** and **Pago Fácil**, follow the steps below. If you have already integrated card payments, you can start the integration from **step 4**.
...
![payment-brick-other-payments-methods-mla](checkout-bricks/payment-brick-other-payments-methods-mla-en.png)
...
In this case, as **Pago Fácil** is the only available means, the list for selecting where to pay will not be displayed. For a complete list of IDs that can be passed within the array, check the [Get Payment Methods](/developers/en/reference/payment_methods/_payment_methods/get) API in our API Reference.
